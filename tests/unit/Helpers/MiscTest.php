...
namespace SymPressCS\SymPress\Tests\Helpers;

use PHP_CodeSniffer\Util\Tokens;
use SymPressCS\SymPress\Helpers\Misc;
use SymPressCS\SymPress\Tests\TestCase;
...
class MiscTest extends TestCase
{
    ...
    public function testMinPhpTestVersion(string $input, string $expected): void
    {
        ...
        static::assertSame($expected, Misc::getMinPhpTestVersion());
    }
